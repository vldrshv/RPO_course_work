...
public class GeozoneLocalServiceImpl extends GeozoneLocalServiceBaseImpl {
	...
	public Geozone addGeozone(long userId, String name, String description, String area, long calendarId,
			String geozoneAttributes, /*long geozoneID*/ ServiceContext serviceContext) throws PortalException {
		...
		//geozone.setGeozoneId(geozoneID);
	...
	//@Override
	//public Geozone delete(long geozoneID) throws PortalException {
